    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorAward", x => new { x.ActorsActorId, x.AwardsAwardId });
                    table.ForeignKey(
                        name: "FK_ActorAward_Actors_ActorsActorId",
                        column: x => x.ActorsActorId,
                        principalTable: "Actors",
                        principalColumn: "ActorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorAward_Awards_AwardsAwardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AwardMovie", x => new { x.AwardsAwardId, x.MoviesMovieId });
                    table.ForeignKey(
                        name: "FK_AwardMovie_Awards_AwardsAwardId",
                        column: x => x.AwardsAwardId,
                        principalTable: "Awards",
                        principalColumn: "AwardId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AwardMovie_Movies_MoviesMovieId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AwardSeries", x => new { x.AwardsAwardId, x.SeriesId });
                    table.ForeignKey(
                        name: "FK_AwardSeries_Awards_AwardsAwardId",
                        column: x => x.AwardsAwardId,
                        principalTable: "Awards",
                        principalColumn: "AwardId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AwardSeries_Series_SeriesId",
                        column: x => x.SeriesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreSeries", x => new { x.GenresGenreId, x.SeriesId });
                    table.ForeignKey(
                        name: "FK_GenreSeries_Genres_GenresGenreId",
                        column: x => x.GenresGenreId,
                        principalTable: "Genres",
                        principalColumn: "GenreId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorAward_AwardsAwardId",
                table: "ActorAward",
                column: "AwardsAwardId");

            migrationBuilder.CreateIndex(
                name: "IX_AwardMovie_MoviesMovieId",
                table: "AwardMovie",
                column: "MoviesMovieId");

            migrationBuilder.CreateIndex(
                name: "IX_AwardSeries_SeriesId",
                table: "AwardSeries",
                column: "SeriesId");
